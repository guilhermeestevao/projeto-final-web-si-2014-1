...
<body>
		...
		<tbody>
			<c:forEach items="${procedimentoList}" var="procedimento">
				<tr>
					...
					<td><a data-toggle="modal" href="#excluirModal${procedimento.id}">Excluir</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	...
	<c:forEach items="${procedimentoList}" var="procedimento">
		<div class="modal fade" id="excluirModal${procedimento.id}" tabindex="-1"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<h3>Deseja realmente excluir o Procedimento: ${procedimento.nome}?</h3>
					</div>
					<div class="modal-footer">
						<a href="remove?id=${procedimento.id}" class="btn btn-primary">Excluir</a>
